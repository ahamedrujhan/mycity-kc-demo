...
class _MyAppState extends State<MyApp> {
  ...
  final String _clientId = 'my_city_mobile_test';
  final String _redirectUrl = 'com.example.kcdemo:/oauthredirect';
  final String _issuer = 'https://kc.mycity.evxtest.monster/realms/Test_Ruju';
  final String _discoveryUrl =
      'https://kc.mycity.evxtest.monster/realms/Test_Ruju/.well-known/openid-configuration';
  final String _postLogoutRedirectUrl = 'com.example.kcdemo:/';
  ...
  final AuthorizationServiceConfiguration _serviceConfiguration =
    ...
    authorizationEndpoint: 'https://kc.mycity.evxtest.monster/realms/Test_Ruju/protocol/openid-connect/auth',
    tokenEndpoint: 'https://kc.mycity.evxtest.monster/realms/Test_Ruju/protocol/openid-connect/token',
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('My City Auth Demo'),
        ),
        body: SafeArea(
